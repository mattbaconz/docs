...
3TSpawner targets **Paper / Purpur `1.20.6` through year-based `26.x`** and requires **Java 21+**.

<Warning>
Folia support is **experimental / beta**. The jar declares `folia-supported`, but do not treat Folia as production-stable until your own soak tests pass.
</Warning>
