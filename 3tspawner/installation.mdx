...
- **Server software**: Paper or Purpur `1.20.6` through `26.x`
...
<Warning>
Folia is experimental. Prefer Paper/Purpur for production until you validate Folia on a staging copy of your world.
</Warning>
