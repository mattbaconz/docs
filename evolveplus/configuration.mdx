...
| File | Purpose |
| :--- | :--- |
| `config.yml` | DRM, database, Redis, Folia behavior, hologram layout, contribution suffixes, and region unlocks. |
...
- `requirements`: Nodes that should exist before this era is considered complete.
